    ...
    if layer.type == "transformation":
        ...
        if covariate_exists is True:
            for cov_value in [0.0, 0.25, 0.5, 0.75, 1.0]:
                ...
                return_dict = layer.forward(data_span_vec, covariate=covariate_value, return_log_d=True)
                ...
                return_dict_inverse = layer.forward(z_tilde, covariate=covariate_value,  inverse=True)
            ...
            return_dict = layer.forward(data_span_vec, covariate=False, return_log_d=True)
            z_tilde = return_dict["output"]
            log_d = return_dict["log_d"]
