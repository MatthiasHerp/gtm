...
if __name__ == "__main__":
    ...
    print(
        "KLD GTM      Train Data: ",
        np.round(torch.mean(loglik_train - log_likelihood_train_gtm).item(), 4),
    )

    print(
        "KLD GTM      Test  Data: ",
        np.round(torch.mean(loglik_test - log_likelihood_test_gtm).item(), 4),
    )
