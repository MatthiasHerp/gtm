...
if __name__ == "__main__":
    ...
    loglik_true_train, loglik_true_validate, loglik_true_test, \
    loglik_true_est_train, loglik_true_est_validate, loglik_true_est_test, \
    log_likelihood_train_gaussian, log_likelihood_validate_gaussian, log_likelihood_test_gaussian = create_simulated_data_joe_copula()
    ...
    optimal_degrees_transformation, optimal_degrees_transformation_pvalues = model.find_minimal_transformation_degrees(dataloader_train, 
                                                                                                                        dataloader_validate, 
                                                                                                                        iterations=100, 
