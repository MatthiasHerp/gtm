...
# Note we set mintau=0.1, maxtau=0.4 as this is the weak scenario
create_copula_par_matrix <- function(D, family, par2=FALSE, mintau=0.1, maxtau=0.4) {
  mat <- family
