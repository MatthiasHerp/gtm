...
create_copula_families_matrix <- function(D, I_percent=0.2, Independence_Tree=2, gauss_only=FALSE) {
  ...
  # Note: 
  # - We have only copulas where we can set the parameters with kendalls tau 
  #   to ensure we don't have to extreme dependencies dominating data,
