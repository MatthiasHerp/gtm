...
create_dvine_structure_matrix <- function(D) {
...
create_copula_families_matrix <- function(D, I_percent=0., Independence_Tree=4, gauss_only=FALSE) {
...
create_sim_study_data <- function(path_string,
  ...
  for (seed_value in seeds){
    ...
    rvinematrix <- create_dvine_structure_matrix(D_dimensions)
